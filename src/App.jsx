    ...
    try {
      ...
      if (geniusId) {
        try {
          ...
          if (annData.annotations && annData.annotations.length) {
            annotationsBlock = "\n\nANNOTATIONS GENIUS REELLES DISPONIBLES POUR CE MORCEAU (ecrites par la communaute, a utiliser comme source si pertinent pour la ligne analysee, sinon ignore-les):\n" +
              annData.annotations.map(function(a) { return "- passage annote: \"" + a.fragment + "\"\n  explication: " + a.annotation; }).join("\n");
          }
        } catch (e) {}
      }
