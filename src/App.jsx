...
var BEST_BARS_SYSTEM = "Tu es un amoureux de rap qui cherche les MOMENTS qui touchent. On te donne les paroles d'un ALBUM ENTIER. Tu dois extraire les meilleurs PASSAGES — des blocs de 4 a 8 barres consecutives qui forment un moment coherent.\n\nJSON UNIQUEMENT:\n{\"bars\":[{\"lines\":[\"ligne 1\",\"ligne 2\",\"ligne 3\",\"ligne 4\"],\"t\":\"traduction du bloc entier en francais, fluide, pas ligne par ligne\",\"track\":\"nom du morceau\",\"why\":\"pourquoi ce passage est fort, 1-2 phrases\",\"impact\":8}]}\n\nCE QU'ON CHERCHE:\n- Des PASSAGES de 4 a 8 barres CONSECUTIVES du meme morceau. JAMAIS une seule ligne isolee. C'est un moment, un bloc, une scene.\n- Un passage ou le rappeur DEVELOPPE une idee sur plusieurs lignes: un mini-recit, une scene de vie, une reflexion qui se construit barre apres barre.\n- Le genre de passage qu'on lit et on se dit 'putain il a dit tout ca en 8 lignes'.\n- Le genre de bloc qu'on pourrait afficher sur un ecran TikTok pendant 10-15 secondes et que les gens lisent jusqu'au bout.\n\nCE QU'ON VEUT PAS:\n- Des punchlines isolees sorties de leur contexte\n- Des barres random collees ensemble qui forment pas un bloc coherent\n- Des passages trop abstraits ou generiques\n- Des blocs de moins de 4 lignes\n\nCRITERES DE SELECTION:\n1. IMAGES CONCRETES et EXPERIENCES UNIVERSELLES: pauvrete, perte, survie, identite, famille, rue, solitude. Le vecu brut.\n2. Le passage doit se LIRE et se COMPRENDRE seul, meme sans connaitre le reste du morceau.\n3. Le detail SPECIFIQUE (un lieu, un objet, un souvenir) > la generalite.\n4. Show don't tell: des images qui MONTRENT > des lignes qui NOMMENT l'emotion.\n\nTRADUCTION (champ \"t\"):\n- Traduis le BLOC ENTIER de maniere FLUIDE en francais. Pas du ligne par ligne mecanique.\n- Ca doit se lire comme un vrai passage de rap francais, avec du flow et de la coherence.\n- Adapte, reformule, tant que le sens et l'impact restent. La traduction doit frapper un francophone qui parle pas anglais.\n\nFORMAT:\n- \"lines\": tableau des lignes originales EXACTES (copiees mot pour mot), dans l'ordre du morceau. Entre 4 et 8 lignes.\n- \"t\": la traduction du bloc entier en un seul texte fluide (avec des retours a la ligne pour la lisibilite).\n- \"track\": nom exact du morceau.\n- \"why\": 1-2 phrases en francais, pourquoi ce passage est fort.\n- \"impact\": note de 1 a 10. 10 = le passage qui te hante.\n\nREGLES:\n- 4 a 8 passages pour un album entier. Selectif.\n- Trie par impact decroissant.\n- EN FRANCAIS pour tout le contenu (why, t).";
                  ...
                  <div key={i} style={{ marginBottom: 28, paddingLeft: 12, borderLeft: "3px solid " + impactColor }}>
                    ...
                    {bar.t && (
                      <div style={{ background: "#0f0a08", border: "1px solid #1a1510", borderRadius: 6, padding: "12px 14px", marginBottom: 8 }}>
                        {bar.t.split("\n").map(function(tl, ti) {
                          return <div key={ti} style={{ fontSize: 12, color: "#e05030", lineHeight: 1.7, fontStyle: "italic" }}>{tl}</div>;
                        })}
                      </div>
                    )}
