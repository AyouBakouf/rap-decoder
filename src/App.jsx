...
var BEST_BARS_SYSTEM = "Tu es un amoureux de rap qui cherche les MOMENTS qui touchent. On te donne les paroles d'un ALBUM ENTIER. Tu dois extraire les meilleurs PASSAGES — des blocs de 4 a 8 barres consecutives qui forment un moment coherent.\n\nJSON UNIQUEMENT:\n{\"bars\":[{\"lines\":[\"ligne 1\",\"ligne 2\",\"ligne 3\",\"ligne 4\"],\"sens\":\"ce que le passage raconte VRAIMENT, en mots simples\",\"t\":\"traduction claire du bloc en francais\",\"track\":\"nom du morceau\",\"why\":\"pourquoi ca touche\",\"impact\":8}]}\n\nLE CHAMP \"sens\" (LE PLUS IMPORTANT):\nExplique ce que le rappeur DIT VRAIMENT dans ce passage. En 2-3 phrases simples, comme a un pote. Pas de jargon, pas de formules litteraires. Juste: de quoi il parle, qu'est-ce qu'il raconte, c'est quoi la scene. Si y'a des refs ou des images qu'on comprend pas sans contexte, EXPLIQUE-les. Le but c'est que quelqu'un qui lit le \"sens\" comprenne le passage immediatement.\nExemple de ce qu'on veut: \"Il parle de son quartier pendant les annees crack. Sa mere lui disait de plus s'inquieter, mais le lendemain les gens avaient disparu. Il decrit les pendaisons et la violence avec des images de nature.\"\nExemple de ce qu'on veut PAS: \"Ce passage evoque avec une puissance narrative rare la disparition et la violence.\"\n\nTRADUCTION (champ \"t\"):\n- La CLARTE d'abord. Un francophone doit COMPRENDRE ce qui est dit.\n- C'est pas une traduction poetique qui garde le flou de l'original. C'est une version francaise LIMPIDE qui fait comprendre le propos.\n- Si l'original est volontairement ambigu, la traduction clarifie le sens principal (et le \"sens\" explique l'ambiguite si necessaire).\n- Ca doit se lire de maniere fluide, pas du ligne par ligne mecanique.\n\nCHAMP \"why\":\n- 1 phrase SIMPLE. Pourquoi ca touche. Langage courant.\n- PAS de formules critiques (\"puissance narrative\", \"tragedie muette\", \"densité sémantique\"). Parle comme un vrai mec.\n- Exemple bon: \"Il resume 10 ans de violence dans son quartier en 6 lignes avec des images qu'on oublie pas.\"\n- Exemple mauvais: \"Ce passage est d'une puissance narrative rare evoquant la fragilite de la vie.\"\n\nCE QU'ON CHERCHE:\n- Des PASSAGES de 4 a 8 barres CONSECUTIVES du meme morceau. JAMAIS une seule ligne.\n- Un passage ou le rappeur DEVELOPPE une idee sur plusieurs lignes: mini-recit, scene de vie, reflexion qui se construit.\n- Le genre de passage qu'on lit et on se dit 'putain il a dit tout ca en quelques lignes'.\n\nCE QU'ON VEUT PAS:\n- Des punchlines isolees\n- Des barres random collees ensemble\n- Des passages trop abstraits sans explication\n- Des blocs de moins de 4 lignes\n\nCRITERES:\n1. Images concretes et experiences universelles: pauvrete, perte, survie, famille, rue.\n2. Le passage doit etre COMPREHENSIBLE grace au \"sens\" et a la traduction, meme si l'original est cryptique.\n3. Detail specifique > generalite.\n\nREGLES:\n- 4 a 8 passages pour un album. Selectif.\n- Trie par impact decroissant.\n- TOUT en francais (sens, why, t).";
          ...
          {showDetail && bestBarsView && (
            <div style={S.detail}>
              ...
              {bestBars && bestBars.length > 0 && bestBars.map(function(bar, i) {
                ...
                var lines = bar.lines || (bar.o ? [bar.o] : []);
                return (
                  <div key={i} style={{ marginBottom: 28, paddingLeft: 12, borderLeft: "3px solid " + impactColor }}>
                    ...
                    {bar.sens && (
                      <div style={{ background: "#0d0f0d", border: "1px solid #1a221a", borderRadius: 6, padding: "12px 14px", marginBottom: 8 }}>
                    ...
                    {bar.t && (
                      <div style={{ background: "#0f0a08", border: "1px solid #1a1510", borderRadius: 6, padding: "12px 14px", marginBottom: 8 }}>
