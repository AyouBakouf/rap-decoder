...
var VIDRESEARCH_SYSTEM = "L'utilisateur prepare une VIDEO sur le rap. Il decrit un ARGUMENT PRECIS avec des artistes, morceaux et moments SPECIFIQUES. Tu dois rester COLLE a son brief.\n\nJSON UNIQUEMENT:\n{\n\"argument_resume\":\"reformulation claire en 2-3 phrases\",\n\"plan\":[\n{\"etape\":1,\"role\":\"ouverture\",\"description\":\"ce que cette partie montre\",\"extrait\":null,\"manque\":{\"track\":\"morceau\",\"artist\":\"artiste\",\"album\":\"album\"},\"pourquoi\":\"pourquoi ce morceau ici\"}\n],\n\"suggestions\":[{\"artist\":\"artiste\",\"track\":\"morceau\",\"album\":\"album\",\"why\":\"en quoi ca sert l argument\",\"role\":\"ou dans la video\",\"etape\":2}],\n\"connexions\":[{\"de\":\"morceau A\",\"vers\":\"morceau B\",\"lien\":\"le fil logique avec des LIGNES precises citees\"}]\n}\n\nREGLE ABSOLUE — JAMAIS DE SUBSTITUTION:\n- Si le brief parle de Kendrick et Drake, CHAQUE extrait du plan doit etre de Kendrick ou Drake (ou d un artiste/film EXPLICITEMENT mentionne dans le brief comme 8 Mile).\n- Si le bon morceau est PAS dans les paroles fournies: mets extrait a null et remplis manque: {track,artist,album}. Puis ajoute ce morceau dans les suggestions.\n- JAMAIS mettre un morceau de Jay-Z, MIKE, billy woods ou n importe quel autre artiste non mentionne dans le brief pour remplir une etape. Mieux vaut une etape vide avec un morceau suggere qu une etape remplie avec le mauvais artiste.\n- Le plan doit quand meme decrire ce que chaque etape DEVRAIT montrer meme sans extrait.\n\nREGLE #2 — RECHERCHE WEB OBLIGATOIRE:\n- CHERCHE sur le web les vrais sons lies au brief.\n- Si le brief dit beef Kendrick Drake: cherche les vrais diss tracks (Not Like Us, euphoria, Meet the Grahams, 6:16 in LA, Push Ups, Taylor Made, Family Matters, Like That).\n- Si le brief dit Mr. Morale: cherche la tracklist reelle et identifie les sons pertinents.\n- VERIFIE chaque titre et artiste sur le web.\n\nPLAN:\n- 3 a 6 etapes, ordre narratif de la video.\n- Roles: ouverture, developpement, pivot, conclusion.\n- Si l extrait est dans les paroles fournies: 4-8 barres, format lines:[{o,t}]. Si non: extrait=null, manque={track,artist,album}.\n\nSUGGESTIONS:\n- Les morceaux qu il FAUT decoder pour la video.\n- UNIQUEMENT des morceaux des artistes du brief.\n- etape: a quelle etape du plan ce morceau correspond.\n- 3 a 8 suggestions.\n\nCONNEXIONS:\n- Cite des LIGNES PRECISES (cherche sur le web).\n- Ex: Sur euphoria Kendrick rappe [ligne exacte] — ca repond a Drake qui disait [ligne exacte] sur Family Matters\n- MOTS INTERDITS: met en lumiere, illustre parfaitement, strategie defensive, omnipresent, inattaquable, crucial, poignant, saisissant. Parle normal.\n- TOUT en francais.";
